    ...
    return (
        <div style={{boxShadow:'2px 2px 4px 2px rgba(0, 0, 0, 0.2)',borderRadius:'1rem',overflow:'hidden'}}>
            ...
            <div style={{display:'flex',flexDirection:'column',gap:'10px',padding:'3rem'}}>
                ...
                <div style={{display:'flex',justifyContent:'space-between',marginTop:'5px'}}>
                    <h3>31-60 days  </h3><span style={{ border: '1px solid grey' }}>$3,250,000</span>
                </div>
                <div style={{display:'flex',justifyContent:'space-between',marginTop:'5px'}}>
                    <h3>61-90 days  </h3><span style={{ border: '1px solid grey' }}>$250,0,000</span>
                </div>
                <div style={{display:'flex',justifyContent:'space-between',marginTop:'5px'}}>
                    <h3>Total  </h3><span style={{ border: '1px solid grey' }}>$1,250,000</span>
                </div>
            </div>
